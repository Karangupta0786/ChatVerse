package com.android.chatverse.sources.cropper;
...
public class CropImageView extends FrameLayout {
    ...
    public CropImageView(Context context, AttributeSet attrs) {
        ...
        if (options == null) {
            ...
            if (attrs != null) {
                TypedArray ta = context.obtainStyledAttributes(attrs, com.mesibo.mediapicker.R.styleable.CropImageView, 0, 0);
                try {
                    options.fixAspectRatio = ta.getBoolean(com.mesibo.mediapicker.R.styleable.CropImageView_cropFixAspectRatio, options.fixAspectRatio);
                    options.aspectRatioX = ta.getInteger(com.mesibo.mediapicker.R.styleable.CropImageView_cropAspectRatioX, options.aspectRatioX);
                    options.aspectRatioY = ta.getInteger(com.mesibo.mediapicker.R.styleable.CropImageView_cropAspectRatioY, options.aspectRatioY);
                    options.scaleType = ScaleType.values()[ta.getInt(com.mesibo.mediapicker.R.styleable.CropImageView_cropScaleType, options.scaleType.ordinal())];
                    options.autoZoomEnabled = ta.getBoolean(com.mesibo.mediapicker.R.styleable.CropImageView_cropAutoZoomEnabled, options.autoZoomEnabled);
                    options.multiTouchEnabled = ta.getBoolean(com.mesibo.mediapicker.R.styleable.CropImageView_cropMultiTouchEnabled, options.multiTouchEnabled);
                    options.maxZoom = ta.getInteger(com.mesibo.mediapicker.R.styleable.CropImageView_cropMaxZoom, options.maxZoom);
                    options.cropShape = CropShape.values()[ta.getInt(com.mesibo.mediapicker.R.styleable.CropImageView_cropShape, options.cropShape.ordinal())];
                    options.guidelines = Guidelines.values()[ta.getInt(com.mesibo.mediapicker.R.styleable.CropImageView_cropGuidelines, options.guidelines.ordinal())];
                    options.snapRadius = ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropSnapRadius, options.snapRadius);
                    options.touchRadius = ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropTouchRadius, options.touchRadius);
                    options.initialCropWindowPaddingRatio = ta.getFloat(com.mesibo.mediapicker.R.styleable.CropImageView_cropInitialCropWindowPaddingRatio, options.initialCropWindowPaddingRatio);
                    options.borderLineThickness = ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropBorderLineThickness, options.borderLineThickness);
                    options.borderLineColor = ta.getInteger(com.mesibo.mediapicker.R.styleable.CropImageView_cropBorderLineColor, options.borderLineColor);
                    options.borderCornerThickness = ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropBorderCornerThickness, options.borderCornerThickness);
                    options.borderCornerOffset = ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropBorderCornerOffset, options.borderCornerOffset);
                    options.borderCornerLength = ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropBorderCornerLength, options.borderCornerLength);
                    options.borderCornerColor = ta.getInteger(com.mesibo.mediapicker.R.styleable.CropImageView_cropBorderCornerColor, options.borderCornerColor);
                    options.guidelinesThickness = ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropGuidelinesThickness, options.guidelinesThickness);
                    options.guidelinesColor = ta.getInteger(com.mesibo.mediapicker.R.styleable.CropImageView_cropGuidelinesColor, options.guidelinesColor);
                    options.backgroundColor = ta.getInteger(com.mesibo.mediapicker.R.styleable.CropImageView_cropBackgroundColor, options.backgroundColor);
                    options.showCropOverlay = ta.getBoolean(com.mesibo.mediapicker.R.styleable.CropImageView_cropShowCropOverlay, this.mShowCropOverlay);
                    options.showProgressBar = ta.getBoolean(com.mesibo.mediapicker.R.styleable.CropImageView_cropShowProgressBar, this.mShowProgressBar);
                    options.borderCornerThickness = ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropBorderCornerThickness, options.borderCornerThickness);
                    options.minCropWindowWidth = (int) ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropMinCropWindowWidth, (float) options.minCropWindowWidth);
                    options.minCropWindowHeight = (int) ta.getDimension(com.mesibo.mediapicker.R.styleable.CropImageView_cropMinCropWindowHeight, (float) options.minCropWindowHeight);
                    options.minCropResultWidth = (int) ta.getFloat(com.mesibo.mediapicker.R.styleable.CropImageView_cropMinCropResultWidthPX, (float) options.minCropResultWidth);
                    options.minCropResultHeight = (int) ta.getFloat(com.mesibo.mediapicker.R.styleable.CropImageView_cropMinCropResultHeightPX, (float) options.minCropResultHeight);
                    options.maxCropResultWidth = (int) ta.getFloat(com.mesibo.mediapicker.R.styleable.CropImageView_cropMaxCropResultWidthPX, (float) options.maxCropResultWidth);
                    options.maxCropResultHeight = (int) ta.getFloat(com.mesibo.mediapicker.R.styleable.CropImageView_cropMaxCropResultHeightPX, (float) options.maxCropResultHeight);
                    options.flipHorizontally = ta.getBoolean(com.mesibo.mediapicker.R.styleable.CropImageView_cropFlipHorizontally, options.flipHorizontally);
                    options.flipVertically = ta.getBoolean(com.mesibo.mediapicker.R.styleable.CropImageView_cropFlipHorizontally, options.flipVertically);
                    this.mSaveBitmapToInstanceState = ta.getBoolean(com.mesibo.mediapicker.R.styleable.CropImageView_cropSaveBitmapToInstanceState, this.mSaveBitmapToInstanceState);
                    if (ta.hasValue(com.mesibo.mediapicker.R.styleable.CropImageView_cropAspectRatioX) && ta.hasValue(com.mesibo.mediapicker.R.styleable.CropImageView_cropAspectRatioX) && !ta.hasValue(com.mesibo.mediapicker.R.styleable.CropImageView_cropFixAspectRatio)) {
