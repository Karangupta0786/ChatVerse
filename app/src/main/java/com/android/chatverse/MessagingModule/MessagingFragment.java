...
import com.android.chatverse.CustomSwipeCallback;
import com.android.chatverse.MessagingModule.AllUtils.LetterTileProvider;
import com.android.chatverse.MessagingModule.AllUtils.TextToEmoji;
import com.android.chatverse.R;
import com.android.chatverse.sources.MediaPicker;
...
//    private MesiboMapScreenshot mMapScreenshot = new MesiboMapScreenshot();
    ...
    public int getLayout() {
        return MesiboUI.getConfig().mMessagingFragmentLayout != 0 ? MesiboUI.getConfig().mMessagingFragmentLayout : R.layout.fragment_chatverse_messaging;
    }
...
//    }
    ...
    private void setProfilePicture() {
        LetterTitleProvider tileProvider = new LetterTitleProvider(this.myActivity(), 60, this.mMesiboUIOptions.mLetterTitleColors);
