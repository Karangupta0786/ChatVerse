...
package com.android.chatverse.MessagingModule;
...
//        MesiboCall.getInstance().init(this);
        ...
        if (args != null) {
            ...
            setContentView(R.layout.activity_chatverse_messaging);
...
//            this.isOnlineDot = (ImageView) findViewById(R.id.isOnlineDot);
            ...
            if (this.mProfileImage != null) {
                ...
                this.mProfileImage.setOnClickListener(new View.OnClickListener() {
                    /* JADX WARNING: type inference failed for: r0v3, types: [android.content.Context, MesiboMessagingActivity] */
                    public void onClick(View v) {
...
//            if (this.mTitle != null) {
            ...
            TextView nameLayout = findViewById(R.id.chat_user);
                nameLayout.setOnClickListener(new View.OnClickListener() {
                    /* JADX WARNING: type inference failed for: r1v0, types: [android.content.Context, MesiboMessagingActivity] */
                    public void onClick(View v) {
...
//    }
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [android.content.Context, MesiboMessagingActivity] */
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [android.content.Context, MesiboMessagingActivity, androidx.appcompat.app.AppCompatActivity] */
    ...
    public void Mesibo_onUpdateUserPicture(MesiboProfile profile, Bitmap thumbnail, String picturePath) {
        ...
        if (this.mProfileImagePath != null) {
            ...
            Log.e("image", mProfileImagePath.toString());
        } else {
            this.mProfileImage.setImageResource(R.drawable.person);
            Log.e("image", "Profile thumbnail is empty or null, setting default image");
        }
...
//            this.isOnlineDot.setVisibility(View.VISIBLE);
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [android.content.Context, MesiboMessagingActivity] */
